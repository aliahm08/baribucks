...
static void order_menu_draw_row_callback(GContext* ctx, const Layer *cell_layer, MenuIndex *cell_index, void *data) {
  switch (cell_index->section) {
    ...
    switch (cell_index->row) {
      case 0:
      menu_cell_title_draw(ctx, cell_layer, "Hot Coffee");
      break;
      case 1:
      menu_cell_title_draw(ctx, cell_layer, "Iced Coffee");
      break;
      case 2:
      menu_cell_title_draw(ctx, cell_layer, "Tea");
      break;
      case 3:
      menu_cell_title_draw(ctx, cell_layer, "Frappuccino");
      break;
    }
    break;
    case 1:
...
static void drink_menu_draw_row_callback(GContext* ctx, const Layer *cell_layer, MenuIndex *cell_index, void *data) {
  switch (cell_index->section) {
    ...
    switch (cell_index->row) {
      case 0:
      menu_cell_title_draw(ctx, cell_layer, "Tall");
      break;
      case 1:
      menu_cell_title_draw(ctx, cell_layer, "Grande");
      break;
      case 2:
      menu_cell_title_draw(ctx, cell_layer, "Venti");
      break;
    }
    break;
  }
...
static void confirmation_menu_draw_row_callback(GContext* ctx, const Layer *cell_layer, MenuIndex *cell_index, void *data) {
  switch (cell_index->row) {
    case 0:
    menu_cell_title_draw(ctx, cell_layer, "Yes");
    break;
    case 1:
    menu_cell_title_draw(ctx, cell_layer, "No");
    break;
  }
}
